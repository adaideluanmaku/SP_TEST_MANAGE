...
`scripttype`  int(10) NULL DEFAULT 1 ,
...
`scriptstatus`  int(10) NULL DEFAULT NULL ,
...
-- ----------------------------
ALTER TABLE `files` AUTO_INCREMENT=90;
...
-- ----------------------------
ALTER TABLE `script` AUTO_INCREMENT=7709;
...
-- ----------------------------
ALTER TABLE `testmng` AUTO_INCREMENT=1290;
