...
SELECT '0' AS hiscode ,allercode ,allername FROM mc_dict_allergen mda
GO
...
SELECT '0' AS hiscode , mdc.itemcode AS itemcode ,mdc.itemname AS itemname ,3 AS itemtype FROM    mc_dict_costitem mdc
GO
...
SELECT '0'AS hiscode, deptcode, deptname, is_clinic, is_inhosp, is_emergency FROM mc_dict_dept
GO
...
SELECT '0'AS hiscode, discode, disname FROM mc_dict_disease mdd
GO
...
SELECT '0'AS hiscode, doctorcode, doctorname, deptcode, deptname, ilevel, doctorlevel,is_clinic, prespriv, ilevel AS antilevel FROM mc_dict_doctor
GO
...
a.DRGGRP_SEARCHCODE,
	...
	b.dddunit,
	a.is_basedrug,
	case when a.DRUGGROUPCODE<100 then 100/(a.DRUGGROUPCODE)+1.4 when a.DRUGGROUPCODE>100 and a.DRUGGROUPCODE<1000 then 1000/(a.DRUGGROUPCODE)+1.7 when  a.DRUGGROUPCODE>1000 and a.DRUGGROUPCODE<10000 then 10000/(a.DRUGGROUPCODE)+1.7 else 10.8 end as unitprice
FROM
	mc_dict_drug a,
	mc_dict_drug_sub b,
	mc_dict_drug_pass c
...
SELECT '0' AS hiscode,examcode, mde.examname FROM mc_dict_exam mde
GO
...
SELECT '0' AS hiscode,mdf.frequency FROM mc_dict_frequency mdf
GO
...
SELECT '0' AS hiscode,itemcode, itemname FROM mc_dict_labsub
GO
...
SELECT '0' AS hiscode,labcode, labname FROM mc_dict_lab
GO
...
SELECT '0' AS hiscode,operationcode,mdo.operationname FROM mc_dict_operation mdo
GO
...
SELECT '0' AS hiscode,routecode, routename FROM mc_dict_route
GO
