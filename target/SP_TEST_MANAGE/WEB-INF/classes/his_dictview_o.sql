...
SELECT 'chview'AS hiscode, doctorcode, doctorname, deptcode, deptname, ilevel, doctorlevel, is_clinic, prespriv, ilevel AS antilevel FROM mc_dict_doctor;

-- ----------------------------
-- View structure for MDC2_DICT_DRUG_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_DRUG_VIEW" AS 
SELECT 'chview'AS hiscode,a.drugcode, c.drug_unique_code, b.drugname, b.drugform, b.drugspec, c.approvalcode, c.comp_name, a.drugtype, a.DRUGGROUPCODE, a.DRUGGROUPNAME, a.DRGGRP_SEARCHCODE, c.doseunit, b.costunit, b.adddate, b.is_use, a.is_anti, a.antitype, a.antilevel, b.ddd, b.dddunit, a.is_basedrug,case when a.DRUGGROUPCODE<100 then 100/(a.DRUGGROUPCODE)+1.4 when a.DRUGGROUPCODE>100 and a.DRUGGROUPCODE<1000 then 1000/(a.DRUGGROUPCODE)+1.7 when  a.DRUGGROUPCODE>1000 and a.DRUGGROUPCODE<10000 then 10000/(a.DRUGGROUPCODE)+1.7 else 10.8 end as unitprice FROM mc_dict_drug a, mc_dict_drug_sub b, mc_dict_drug_pass c where a.drugcode=b.drugcode and a.drugcode=c.drugcode;
