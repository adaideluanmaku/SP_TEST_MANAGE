...
SELECT '1609PA' AS hiscode ,allercode ,allername FROM mc_dict_allergen mda;

-- ----------------------------
-- View structure for MDC2_DICT_COST_ITEM_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_COST_ITEM_VIEW" AS 
SELECT '1609PA' AS hiscode , mdc.itemcode AS itemcode ,mdc.itemname AS itemname ,3 AS itemtype FROM    mc_dict_costitem mdc;

-- ----------------------------
-- View structure for MDC2_DICT_DEPT_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_DEPT_VIEW" AS 
SELECT '1609PA'AS hiscode, deptcode, deptname, is_clinic, is_inhosp, is_emergency FROM mc_dict_dept;

-- ----------------------------
-- View structure for MDC2_DICT_DISEASE_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_DISEASE_VIEW" AS 
SELECT '1609PA'AS hiscode, discode, disname FROM mc_dict_disease mdd;

-- ----------------------------
-- View structure for MDC2_DICT_DOCTOR_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_DOCTOR_VIEW" AS 
SELECT '1609PA'AS hiscode, doctorcode, doctorname, deptcode, deptname, ilevel, doctorlevel, 1 AS is_clinic, 1 AS prespriv, ilevel AS antilevel FROM mc_dict_doctor;

-- ----------------------------
-- View structure for MDC2_DICT_DRUG_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_DRUG_VIEW" AS 
SELECT '1609PA'AS hiscode,a.drugcode, c.drug_unique_code, b.drugname, b.drugform, b.drugspec, c.approvalcode, c.comp_name, a.drugtype, a.DRUGGROUPCODE, a.DRUGGROUPNAME, a.DRGGRP_SEARCHCODE, c.doseunit, b.costunit, b.adddate, b.is_use, a.is_anti, a.antitype, a.antilevel, b.ddd, b.dddunit, a.is_basedrug,88 AS unitprice FROM mc_dict_drug a, mc_dict_drug_sub b, mc_dict_drug_pass c where a.drugcode=b.drugcode and a.drugcode=c.drugcode;

-- ----------------------------
-- View structure for MDC2_DICT_EXAM_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_EXAM_VIEW" AS 
SELECT '1609PA' AS hiscode,examcode, mde.examname FROM mc_dict_exam mde;

-- ----------------------------
-- View structure for MDC2_DICT_FREQUENCY_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_FREQUENCY_VIEW" AS 
SELECT '1609PA' AS hiscode,mdf.frequency FROM mc_dict_frequency mdf;

-- ----------------------------
-- View structure for MDC2_DICT_LAB_ITEM_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_LAB_ITEM_VIEW" AS 
SELECT '1609PA' AS hiscode,itemcode, itemname FROM mc_dict_labsub;

-- ----------------------------
-- View structure for MDC2_DICT_LAB_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_LAB_VIEW" AS 
SELECT '1609PA' AS hiscode,labcode, labname FROM mc_dict_lab;

-- ----------------------------
-- View structure for MDC2_DICT_OPERATION_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_OPERATION_VIEW" AS 
SELECT '1609PA' AS hiscode,operationcode,mdo.operationname FROM mc_dict_operation mdo;

-- ----------------------------
-- View structure for MDC2_DICT_ROUTE_VIEW
-- ----------------------------
CREATE OR REPLACE FORCE VIEW "MDC2_DICT_ROUTE_VIEW" AS 
SELECT '1609PA' AS hiscode,routecode, routename FROM mc_dict_route;
